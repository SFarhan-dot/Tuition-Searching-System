...
<div class="tdm-topnav" id="mytdm-topnav">
  <a><b>Tuition Searching System</b></a>
  <a href="homepage.php">Home</a>
  <a href="Show_teacher.php">Show Tutor</a>
<a href="search_student.php">Search Student</a>
  ...
  <div class="tdm-dropdown">
    ...
    <div class="tdm-dropdown-content">
      <a href="student_registration.php">Tuition Register </a>
      <a href="teacher_registration.php">Teacher Register</a>
    </div>
  </div>

  <a href="index.php">Log In</a>
  <a href='indexadmin.php' class='has-sub'><span>Admin</span></a>
